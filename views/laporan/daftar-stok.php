        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Daftar Stok</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-hover align-middle">
                            <thead class="table-light">
                                ...
                                <th class="th-sortable <?= ($sortBy ?? 'namabarang') === 'satuan' ? (($sortOrder ?? 'ASC') === 'ASC' ? 'sorted-asc' : 'sorted-desc') : '' ?>">
                                    <a href="<?= getSortUrlLaporanStok('satuan', $sortBy ?? 'namabarang', $sortOrder ?? 'ASC', $search ?? '', $perPage ?? 10, $kodepabrik ?? '', $kodegolongan ?? '', $kondisiStok ?? 'semua') ?>" class="text-decoration-none text-dark">
                                        Satuan
                                    </a>
                                </th>
