                    ...
                    <div class="row mb-3">
                        <form method="GET" action="/mastersupplier" id="searchForm">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-6 col-md-2">
                                    <a href="/mastersupplier?page=1&per_page=10&status=&sort_by=<?= htmlspecialchars($sortBy) ?>&sort_order=<?= htmlspecialchars($sortOrder) ?>" class="btn btn-filter btn-outline-secondary w-100">Reset</a>
                                </div>
                            </div>
