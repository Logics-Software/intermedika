...
<div class="container">
    <div class="breadcrumb-item">
        <div class="col-12">
            <nav aria-label="breadcrumb" data-breadcrumb-parent="/penerimaan">
                <ol class="breadcrumb">
...
?>
<script>
const penerimaanCustomersByStatus = <?= $customersStatusJsonSafe ?? '{}' ?> || {};
...
function findChoiceInstanceForSelect(selectElement) {
    ...
    return customerChoiceInstance && customerChoiceInstance.passedElement && customerChoiceInstance.passedElement.element === selectElement
        ? customerChoiceInstance
        : null;
}
...
function initPenerimaanCreateForm() {
    ...
    // Setup customer status filter
    setupCustomerStatusFilter(customerSelect, statusSelect, penerimaanCustomersByStatus);
...
if (document.readyState === 'complete') {
    initPenerimaanCreateForm();
} else {
    window.addEventListener('load', initPenerimaanCreateForm);
}
</script>
