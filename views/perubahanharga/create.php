<?php
$title = 'Tambah Data Perubahan Harga';
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">Tambah Data Perubahan Harga</h4>
                    </div>
                </div>

                <form method="POST" action="/perubahanharga/create" id="perubahanhargaForm">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="noperubahan" class="form-label">No. Perubahan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="noperubahan" name="noperubahan" required placeholder="Masukkan no perubahan" maxlength="15">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tanggalperubahan" class="form-label">Tanggal Perubahan <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="tanggalperubahan" name="tanggalperubahan" required value="<?= date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="keterangan" class="form-label">Keterangan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="keterangan" name="keterangan" required placeholder="Masukkan keterangan" maxlength="100">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="hargalama" name="hargalama" required step="0.01" min="0" value="0">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="discountlama" class="form-label">Discount Lama</label>
                                <input type="number" class="form-control" id="discountlama" name="discountlama" step="0.01" min="0" value="0">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="hargabaru" class="form-label">Harga Baru <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="hargabaru" name="hargabaru" required step="0.01" min="0" value="0">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="discountbaru" class="form-label">Discount Baru</label>
                                <input type="number" class="form-control" id="discountbaru" name="discountbaru" step="0.01" min="0" value="0">
                            </div>
                        </div>
                    </div>
