            ...
            <div class="card">
                <div class="card-header"<?= !empty($backUrl ?? '') ? ' data-back-url="' . htmlspecialchars($backUrl) . '"' : '' ?>>
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">Edit Order <?= icon('caret-right', 'me-0 mb-1', 14)?> <?= htmlspecialchars($order['noorder']) ?></h4>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="" id="orderForm" enctype="multipart/form-data">
                        <div class="row g-3 mb-3">
                            <div class="col-6 col-md-3 col-lg-2">
                                ...
                                <input type="text" class="form-control" value="<?= htmlspecialchars(date('d/m/Y', strtotime($order['tanggalorder'] ?? date('Y-m-d')))) ?>" readonly>
                            </div>
                            <div class="col-6 col-md-3 col-lg-2">
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive d-none d-md-block">
                                <table class="table table-bordered align-middle order-items-table table-detail-barang mb-0" id="detailTable">
